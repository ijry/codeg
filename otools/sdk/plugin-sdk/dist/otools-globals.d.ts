...
export interface OToolsAPI {
    ...
    setSubInput?(callback?: ((event: OToolsSubInputEvent) => void) | OToolsSubInputOptions, placeholder?: string, isFocus?: boolean): boolean;
    ...
    showOpenDialog?(options?: OToolsDialogOpenOptions, callback?: (result: string | string[] | null) => void): Promise<string | string[] | null>;
    showSaveDialog?(options?: OToolsDialogSaveOptions, callback?: (result: string | null) => void): Promise<string | null>;
    ...
    invokeNativePluginRaw?<T = unknown>(uuid: string, method: string, payload?: unknown): Promise<T>;
    ...
    hostRunWingetInstall?(packageName: string, options?: Record<string, unknown>): Promise<unknown>;
    hostRunPackageAction?(packageName: string, options?: Record<string, unknown>): Promise<unknown>;
    hostGetPackageStatus?(packageName: string, options?: Record<string, unknown>): Promise<unknown>;
    hostGetPackagesStatus?(packageNames: string[], options?: Record<string, unknown>): Promise<unknown>;
    ...
    listenNativePlugin?(uuid: string, handler: (event: {
        event?: string;
        id?: number;
        payload?: {
            topic?: string;
    ...
    getPluginSyncState<T = unknown>(plugin?: string, scheme?: string | null): Promise<T | null>;
    savePluginSyncState(plugin?: string, state?: unknown, scheme?: string | null): Promise<void>;
    getPluginSyncStateValue<T = unknown>(plugin?: string, key?: string, scheme?: string | null): Promise<T | null>;
    savePluginSyncStateValue(plugin?: string, key?: string, value?: unknown, scheme?: string | null): Promise<void>;
    patchPluginSyncState(plugin?: string, patch?: Record<string, unknown>, scheme?: string | null): Promise<void>;
    runtime?: OToolsRuntimeAPI;
