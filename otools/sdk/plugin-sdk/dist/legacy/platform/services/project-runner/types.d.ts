...
export type ProjectRunCommandErrorCode = 'EMPTY_COMMAND' | 'SYSTEM_TERMINAL_FAILED' | 'BUILTIN_TERMINAL_NOT_READY' | 'BUILTIN_TERMINAL_FAILED';
export type ProjectRunCommandSuccessCode = 'SYSTEM_TERMINAL_OPENED' | 'BUILTIN_TERMINAL_EXECUTED';
...
export type ProjectRunCommandPrepareHook = () => Promise<ProjectBuiltinTerminalHandle | null> | ProjectBuiltinTerminalHandle | null;
