...
pub const UPDATE_MANIFEST_URL: &str =
    "https://github.com/ijry/codeg-plus/releases/latest/download/latest.json";
...
pub const RELEASE_DOWNLOAD_BASE: &str =
    "https://github.com/ijry/codeg-plus/releases/latest/download";
...
static MANIFEST_HTTP_CLIENT: LazyLock<Result<reqwest::Client, String>> = LazyLock::new(|| {
    reqwest::Client::builder()
        ...
        .user_agent(concat!("codeg-plus/", env!("CARGO_PKG_VERSION")))
        .build()
