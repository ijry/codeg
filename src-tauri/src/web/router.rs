...
pub fn build_router(
    ...
    let api = Router::new()
        ...
        .route(
            "/open_otools_window",
            post(handlers::otools::open_otools_window),
        )
        .route(
            "/otools_list_plugins",
        ...
        .route(
            "/otools_plugin_state_get",
            post(handlers::otools::otools_plugin_state_get),
        )
        .route(
            "/otools_plugin_state_set",
            post(handlers::otools::otools_plugin_state_set),
        )
        .route(
            "/get_otools_plugin_localstate",
            post(handlers::otools::get_otools_plugin_localstate),
        )
        .route(
            "/save_otools_plugin_localstate",
            post(handlers::otools::save_otools_plugin_localstate),
        )
        .route(
            "/get_otools_plugin_localstate_with_scheme",
            post(handlers::otools::get_otools_plugin_localstate_with_scheme),
        )
        .route(
            "/save_otools_plugin_localstate_with_scheme",
            post(handlers::otools::save_otools_plugin_localstate_with_scheme),
        )
        .route(
            "/get_otools_plugin_syncstate",
            post(handlers::otools::get_otools_plugin_syncstate),
        )
        .route(
            "/save_otools_plugin_syncstate",
            post(handlers::otools::save_otools_plugin_syncstate),
        )
        .route(
            "/get_otools_plugin_syncstate_with_scheme",
            post(handlers::otools::get_otools_plugin_syncstate_with_scheme),
        )
        .route(
            "/save_otools_plugin_syncstate_with_scheme",
            post(handlers::otools::save_otools_plugin_syncstate_with_scheme),
        )
        .route(
            "/get_otools_plugin_localstate_value",
            post(handlers::otools::get_otools_plugin_localstate_value),
        )
        .route(
            "/save_otools_plugin_localstate_value",
            post(handlers::otools::save_otools_plugin_localstate_value),
        )
        .route(
            "/patch_otools_plugin_localstate",
            post(handlers::otools::patch_otools_plugin_localstate),
        )
        .route(
            "/get_otools_plugin_localstate_value_with_scheme",
            post(handlers::otools::get_otools_plugin_localstate_value_with_scheme),
        )
        .route(
            "/save_otools_plugin_localstate_value_with_scheme",
            post(handlers::otools::save_otools_plugin_localstate_value_with_scheme),
        )
        .route(
            "/patch_otools_plugin_localstate_with_scheme",
            post(handlers::otools::patch_otools_plugin_localstate_with_scheme),
        )
        .route(
            "/get_otools_plugin_syncstate_value",
            post(handlers::otools::get_otools_plugin_syncstate_value),
        )
        .route(
            "/save_otools_plugin_syncstate_value",
            post(handlers::otools::save_otools_plugin_syncstate_value),
        )
        .route(
            "/patch_otools_plugin_syncstate",
            post(handlers::otools::patch_otools_plugin_syncstate),
        )
        .route(
            "/get_otools_plugin_syncstate_value_with_scheme",
            post(handlers::otools::get_otools_plugin_syncstate_value_with_scheme),
        )
        .route(
            "/save_otools_plugin_syncstate_value_with_scheme",
            post(handlers::otools::save_otools_plugin_syncstate_value_with_scheme),
        )
        .route(
            "/patch_otools_plugin_syncstate_with_scheme",
            post(handlers::otools::patch_otools_plugin_syncstate_with_scheme),
        )
        .route(
            "/otools_get_plugin_asset",
        ...
        .route(
            "/dev_get_workspace",
            post(handlers::otools::dev_get_workspace),
        )
        .route(
            "/dev_create_plugin",
            post(handlers::otools::dev_create_plugin),
        )
        .route(
            "/dev_update_plugin",
            post(handlers::otools::dev_update_plugin),
        )
        .route(
            "/dev_bind_plugin_directory",
            post(handlers::otools::dev_bind_plugin_directory),
        )
        .route(
            "/dev_enable_debug",
            post(handlers::otools::dev_enable_debug),
        )
        .route(
            "/dev_disable_debug",
            post(handlers::otools::dev_disable_debug),
        )
        .route(
            "/dev_initialize_vue_project",
            post(handlers::otools::dev_initialize_vue_project),
        )
        .route(
            "/dev_initialize_native_project",
            post(handlers::otools::dev_initialize_native_project),
        )
        .route(
            "/dev_build_native_plugin",
            post(handlers::otools::dev_build_native_plugin),
        )
        .route(
            "/dev_build_native_artifact",
            post(handlers::otools::dev_build_native_artifact),
        )
        .route(
            "/dev_build_native_artifact_from_dir",
            post(handlers::otools::dev_build_native_artifact_from_dir),
        )
        .route(
            "/dev_start_native_plugin_build",
            post(handlers::otools::dev_start_native_plugin_build),
        )
        .route(
            "/dev_start_native_artifact_build_from_dir",
            post(handlers::otools::dev_start_native_artifact_build_from_dir),
        )
        .route(
            "/dev_get_native_build_job",
            post(handlers::otools::dev_get_native_build_job),
        )
        .route(
            "/dev_get_native_config",
            post(handlers::otools::dev_get_native_config),
        )
        .route(
            "/dev_set_native_enabled",
            post(handlers::otools::dev_set_native_enabled),
        )
        .route("/dev_pack_plugin", post(handlers::otools::dev_pack_plugin))
        .route(
            "/dev_publish_version",
            post(handlers::otools::dev_publish_version),
        )
        .route(
            "/park_get_workspace",
            post(handlers::otools::park_get_workspace),
        )
        .route(
            "/park_install_plugin",
            post(handlers::otools::park_install_plugin),
        )
        .route(
            "/park_install_offline_plugin",
            post(handlers::otools::park_install_offline_plugin),
        )
        .route(
            "/park_uninstall_plugin",
            post(handlers::otools::park_uninstall_plugin),
        )
        .route(
        ...
        .route(
            ...
            post(handlers::otools::tools_webview_write_file),
        )
        .route(
            "/tools_webview_list_dir",
            post(handlers::otools::tools_webview_list_dir),
        )
        .route(
            "/tools_webview_home_dir",
            post(handlers::otools::tools_webview_home_dir),
        )
        .route(
            "/tools_webview_join_path",
            post(handlers::otools::tools_webview_join_path),
        )
        .route(
            "/tools_webview_create_dir",
            post(handlers::otools::tools_webview_create_dir),
        )
        .route(
            "/tools_webview_touch_file",
            post(handlers::otools::tools_webview_touch_file),
        )
        .route(
            "/tools_webview_remove_entry",
            post(handlers::otools::tools_webview_remove_entry),
        )
        .route(
            "/tools_webview_rename_entry",
            post(handlers::otools::tools_webview_rename_entry),
        )
        .route(
            "/tools_webview_browse_dialog",
            post(handlers::otools::tools_webview_browse_dialog),
        )
        .route(
            "/tools_webview_log",
        ...
        .route(
            ...
            post(handlers::otools::otools_host_scan_storage_catalog),
        )
        .route(
            "/otools_host_clean_storage_paths",
            post(handlers::otools::otools_host_clean_storage_paths),
        )
        .route(
            "/otools_host_clean_storage_items",
            post(handlers::otools::otools_host_clean_storage_items),
        )
        .route(
            "/otools_host_get_package_status",
            post(handlers::otools::otools_host_get_package_status),
        )
        .route(
            "/otools_host_get_packages_status",
            post(handlers::otools::otools_host_get_packages_status),
        )
        .route(
            "/otools_host_list_listen_processes",
            post(handlers::otools::otools_host_list_listen_processes),
        )
        .route(
            "/otools_host_kill_process",
            post(handlers::otools::otools_host_kill_process),
        )
        .route(
        ...
        .route(
            ...
            post(handlers::otools::otools_host_http_write_base64_file),
        )
        .route(
            "/otools_host_http_send",
            post(handlers::otools::otools_host_http_send),
        )
        // ─── Git (pure) ───
